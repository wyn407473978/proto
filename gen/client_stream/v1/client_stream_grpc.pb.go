...
func (c *clientStreamClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (ClientStream_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &ClientStream_ServiceDesc.Streams[0], "/client_stream_v1.ClientStream/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
var ClientStream_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "client_stream_v1.ClientStream",
	...
	Metadata: "client_stream/v1/client_stream.proto",
}
